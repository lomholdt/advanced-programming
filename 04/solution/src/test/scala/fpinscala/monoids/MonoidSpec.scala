...
object MonoidSpec extends Properties("Monoids..") {
  ...
  property ("optionMonoid_gen[List[Int]] is a monoid") =
    monoid (optionMonoid_gen[List[Int]] (listMonoid[Int]))
  property ("dual of optionMonoid_gen[List[Int]] is a monoid") =
    monoid (dual(optionMonoid_gen[List[Int]] (listMonoid[Int])))
